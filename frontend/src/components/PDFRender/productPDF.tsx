...
const styles = StyleSheet.create({
    ...
    tableCell: {
        paddingTop: "8px", // Increase cell padding
        paddingBottom: "8px", // Increase cell padding
        textAlign: "center",
        fontSize: 14, // Increase cell font size
    },
    headerFont: {
        margin: "auto",
        marginTop: 5,
...
export const ProductPDF = ({ data }: any) => {
                            ...
                            <View style={styles.table}>
                                <View style={styles.tableRow}>
                                    <View style={styles.HeaderCol}>
                                        <Text style={styles.headerFont}>Product ID</Text>
                                    </View>
                                    <View style={styles.HeaderCol}>
                                        <Text style={styles.headerFont}>Code</Text>
                                    </View>
                                    <View style={styles.HeaderCol}>
                                    ...
                                    ? data.map((data: any, i: any) => (
                                        <View key={i} style={styles.tableRow}>
                                            <View style={styles.tableCol}>
                                                <Text style={styles.tableCell}>{data.product_id}</Text>
                                            </View>
                                            <View style={styles.tableCol}>
                                                <Text style={styles.tableCell}>{data.code}</Text>
                                            </View>
                                            <View style={styles.tableCol}>
                                                <Text style={styles.tableCell}>{data.brand}</Text>
                                            </View>
                                            <View style={styles.tableCol}>
