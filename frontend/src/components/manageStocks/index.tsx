            ...
            <>
              <Group spacing={"xs"}>
                ...
                <Popover
                  ...
                  disabled={
                    // row.quantity === 0 ||
                    cartOpened === true || openedInvoiceModal === true
                      ? true
                      : false
                  }
                >
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          ...
          <TextInput
            ...
            required
            mb={10}
            {...customerForm.getInputProps("workername")}
          />
      ...
      >
          ...
          >
            ...
            >
              <Select
                ...
                defaultChecked
                value={vatType}
                data={[{ value: "PERCENTAGE", label: "Percentage" }]}
                onChange={(e) => {
                  setVatType(e ? e : "");
                }}
              />
        ...
        <Text>All the Vat and Tax are includeed in Total Price</Text>
      ...
      >
        <form onSubmit={addForm.onSubmit((values) => addItems(values))}>
          ...
          <TextInput
            label="Price"
            placeholder="Enter Price of a Service"
